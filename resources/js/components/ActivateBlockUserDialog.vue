    ...
    <Dialog v-model:open="modelValue">
        <DialogContent>
            <DialogHeader>
                <DialogTitle
                    >{{
                        user.status.id === Status.PENDING
                            ? 'Validar o Utilizador?'
                            : user.status.id === Status.ACTIVE
                ...
                <DialogDescription>
                    ...
                    {{ user.status.id === Status.PENDING ? 'validar' : user.status.id === Status.ACTIVE ? 'desativar' : 'validar' }} este utilizador?
                </DialogDescription>
            </DialogHeader>
            <DialogFooter>
                ...
                <Button
                    @click="
                        handleConfirm(
                            user.status.id === Status.PENDING ? Status.ACTIVE : user.status.id === Status.ACTIVE ? Status.BLOCKED : Status.ACTIVE,
                        )
                    "
